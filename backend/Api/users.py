...
def create_user(request: UserCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        return {
            ...
            "email": created.email,
            "role": UserRepository.get_role_name_by_id(db, created.role_id),
            "password": getattr(created, "raw_generated_password", None),
            "autoGeneratedPassword": getattr(created, "raw_generated_password", None)
        }
